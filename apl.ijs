...
NB. 5. A store sells 3 items, a b c.  over a week, the amounts sold are 8 15 7.  The following week the sales are 12 4 0.  The prices from week 1 are 3.10, 2.00, 4.17, and week 2 they are 3.50, 2.75, 4.35.  Put this data into a matrix p and use it to construct a table of total sales revenue by item over the 2 week period.
w1amounts=:8 15 7
w2amounts=:12 4 0
